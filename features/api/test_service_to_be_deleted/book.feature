...
Feature: Scenarios related to Book REST API in Library Information System
    ...
    @regression @sanity @singleBook @P0
    ...
    @regression @sanity @deleteBook @P0
    ...
    @regression @sanity @updateBook @P0
    ...
    @regression @sanity @searchBook @P0
